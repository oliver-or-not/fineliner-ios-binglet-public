...
final actor LegacyV1AppStateAgentStorageWorker {

    func get<T: Decodable & Sendable>(_ type: T.Type, forKey key: LegacyV1AppStateAgentStorageKey) async -> T? {
    ...
    func set<T: Encodable & Sendable>(_ value: T?, forKey key: LegacyV1AppStateAgentStorageKey) async {
        let defaults = UserDefaults.standard
