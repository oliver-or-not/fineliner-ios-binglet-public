...
actor LegacyV1AppStateAgentStorableItem<StorageDataType: Codable & Sendable, RamDataType: Sendable> {

    private var state: State = .notRestored
    private let storageKey: LegacyV1AppStateAgentStorageKey
    ...
    init(
        storageKey: LegacyV1AppStateAgentStorageKey,
        ...
        storageWorker: LegacyV1AppStateAgentStorageWorker
    ) {
